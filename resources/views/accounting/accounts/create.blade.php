	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-accounts" action="{{route('accounts.store')}}" method="POST">
					@csrf
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								<div class="input-group">
									...
									<select class="form-control" name="category" id="category">
										<option value="-1" selected>--Select account category--</option>
										<option value = "Cash at Bank">Cash at Bank</option>
										<option value = "Cash In Hand">cash In Hand</option>
										<option value ="Current Assets">Current Assets</option>
										<option value ="Fixed Assets">Fixed Assets</option>
										<option value ="Trade & Other Receivables">Trade & Other Receivables</option>
										...
										<option value ="Trade & Other Payables">Trade & Other Payables</option>
