	...
	<div class="col-md-10">
		<div class="box  box-primary">
			<div class="box-header">
				<h3 class="text-primary"><span class="glyphicon glyphicon-knight"></span><strong> New Credit Note</strong></h3>
			...
			<div class="box-body">
				<form class="form-credits" action="{{route('creditnotes.store')}}" method="POST">
					@csrf
					<div class="row">
						...
						<div class="col-md-12">
							<div class="pull-right form-group {{ $errors->has('code') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<input type="text" name="gtotal"  id="gtotalx" class="text-right form-control" value="0.00" placeholder="" readonly>
								</div>
							</div>	
						</div>
					</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="pull-right form-group {{ $errors->has('code') ? ' has-error' : '' }}">
										<div class="input-group">
											<span class="input-group-addon danger">Total Credit</span>
											<input type="text" name="gtotal"  id="gtotal" class="text-right form-control" value="0.00" placeholder="" readonly>
										</div>
									</div>	
								</div>
							</div>					   						
