						...
						<table class="table  compact row-border hover" style="width:100%;" id="item-table">
							...
							<tbody>
								...
								<tr>
									...
									<td>@if($receipt->status==0)<span class="label label-warning label-as-badge"> Unposted</span> @else <span class="label label-success label-as-badge">Posted</span> @endif</td>
