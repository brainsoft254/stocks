		     ...
		     <div class="row">
		        <div class="col-md-6">
				     <div class="box box-solid box-primary">
				        ...
				        <div class="box-body">
		        			<br/>
				        	<form class="form-debtor" action="{{url('adddebtor')}}" method="POST">
							{{csrf_field()}}
			   					<div class="row">
				   					<div class="col-md-12">
					   					<div class="col-md-7">
					   					...
					   					<div class="col-md-12">
						   					<div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
						   						<div class="input-group">
						   							...
						   							<input type="text" name="description" class="form-control" placeholder="Enter debtor description" >
						   						</div>
						   					</div>
					   					</div>
				   					</div>
				   						...
				   						<div class = "col-md-12">
						   					<div class="form-group {{ $errors->has('telphone') ? ' has-error' : '' }}">
						   						<div class="input-group">
						   							...
						   							<input type="text" name="tel" class="form-control" placeholder="Enter telphone or cellphone" >
						   						</div>
						   					</div>
					   					</div>
				   					</div>
				   						...
				   						<div class = "col-md-12">
						   					<div class="form-group {{ $errors->has('remarks') ? ' has-error' : '' }}">
						   						<div class="input-group">
						   							...
						   							<textarea type="text" name="remarks" class="form-control" placeholder="Enter some remarks"></textarea>
						   						</div>
						   					</div>
					   					</div>
				   					</div>
