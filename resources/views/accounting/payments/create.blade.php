<section class="section">
	<div class="row">
		<div class="col-md-12 ">
			<h3 class="text-default alert alert-info"><span class="fa fa-gift"> </span><strong> New Voucher</strong></h3>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
	...
	<div class="row">
		<div class="col-md-12">
			<form class="form-payments" action="{{route('payments.store')}}" method="POST">
				{{csrf_field()}}
				<div class="ui-client-details">
					<fieldset>
								...
								<div class="form-group">
									<div class="input-group {{ $errors->has('entrydate') ? ' has-error' : '' }}">
										<div class="input-group">
											<span class="input-group-addon reams-input-addon"><i class="fa fa-calendar-o"></i>Entry Date</span>
							...
							<div class="col-md-8">
								<div class="form-group {{ $errors->has('payee') ? ' has-error' : '' }}">
									<div class="input-group">
										...
										<input type="text" name="payee"  id="payee" class="col-md-6 form-control payee" value="" placeholder="Enter payee name" >
									</div>
								</div>
							</div>
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="form-group">
									<div class="input-group {{ $errors->has('pinno') ? ' has-error' : '' }}">
										...
										<input type="text" id="pinno" name="pinno" class="form-control" value="" placeholder="Enter Pinno">
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<div class="input-group {{ $errors->has('docno') ? ' has-error' : '' }}">
										...
										<input type="text" id="docno" name="docno" class="form-control" value="" placeholder="Enter Document No">
									</div>
								</div>
							</div>
							...
							<div class="col-md-8">
								<div class="form-group {{ $errors->has('remarks') ? ' has-error' : '' }}">
									<div class="input-group">
										...
										<input type="text" name="remarks"  id="remarks" class="col-md-6 form-control remarks" value="" placeholder="Enter Some remarks" >
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<textarea name="towords"  id="towords" class="text-left form-control" placeholder="" readonly  style="resize:none"></textarea> 
							...
							<div class="col-md-4">
								<div class="pull-right form-group {{ $errors->has('total') ? ' has-error' : ''}}">
									<div class="input-group">
										...
										<b><input type="text" name="total"  id="total" class="text-right form-control" value="0.00" placeholder="" readonly></b>
									</div>
								</div>  
							</div>
						</div> 
						<div class="row">
							<div class="col-md-12">
								<button type="submit" class="btn btn-primary col-md-3"><i class="fa fa-check-square"></i> Save / Update</button>
							</div>
						</div>
					</fieldset>
				</div>
