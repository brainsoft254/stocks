        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="title">Supplier Profile </h3>
                </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="tab-info" style="padding-top:10px;">
                        <form class="form-client" id="form-client" action="{{route('payables.store')}}" method="POST" novalidate="" >
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group {{ $errors->has('paymode') ? ' has-error' : '' }}" id="status-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="paymode" id="paymode">
                                                <option value="1" selected="selected">Account</option>
...
<script type="text/javascript">
    $(function(){
        ...
        $('#parentcl,#vatexc').bootstrapToggle();
