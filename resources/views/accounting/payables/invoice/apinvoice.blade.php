		        ...
		        <div class="col-md-12">
				     <div class="box box-solid box-primary">
				        <div class="box-header">
				          <h3 class="text-default"><i class="glyphicon glyphicon-tower"></i> <strong> New Creditor Invoice</strong></h3>
				        ...
				        <div class="box-body">
							<div class="tab-content">
			        			...
			        			<br/>
						        	<form class="form-arinvoice" action="{{url('save-payable-invoice')}}" method="POST">
									{{csrf_field()}}
					   					<div class="row">
						   					<div class="col-md-12">
							   					<div class="col-md-3">
						   				...
						   				<div class = "row">
						   					<div class = "col-md-12">
						   						...
						   						<div class = "col-md-7"><!-- description -->
								   					<div class="form-group {{ $errors->has('sname') ? ' has-error' : '' }}" id="clientname-group">
								   						<div class="input-group">
					   					...
					   					<div class = "col-md-12">
            								<legend class="text-primary">Select Cost Centres</legend>
            							</div>
						   			 	<div class="row"> 
						   			 	   <div class="col-md-12"> 
							   			 	   <div class="col-md-12"> 
						   				...
						   				<div class="row">
						   					<div class="col-md-12">
							   					<div class="col-md-6">
							   						<button class="btn btn-primary"><i class="fa fa-floppy-o"></i> Save Creditor Invoice</button>
							   					</div>
						   					</div>
						   				</div>
				   					</form>
