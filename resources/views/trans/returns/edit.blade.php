	...
	<div class="col-md-10">
		<div class="box  box-primary">
			<div class="box-header">
				<h3 class="text-primary"><span class="glyphicon glyphicon-knight"></span><strong> Edit Stock Return</strong><span class="ui-marker"></span></h3>
					...
					<div class="ui-cl-invoices">
							...
							<div class="col-md-4 form-group">
								<div class="input-group">
									...
									<select class="form-control rtmode" name="rtmode" id="rtmode">
										...
										<option value="0" {{($return->rtmode==0?'selected':'')}}>Normal</option>
										<option value="1" {{($return->rtmode==1?'selected':'')}}>Breakage</option>
										<option value="2" {{($return->rtmode==2?'selected':'')}}>Replacement</option>
									</select>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-8 form-group {{ $errors->has('clcode') ? ' has-error' : '' }}" id="clcode-group">
								<div class="input-group">
									...
									<div class="col-md-4"><input type="text" name="rtype" id="rtype" class="form-control" value="1" placeholder="" readonly="" style="display:none;"></div>
								</div>
							</div>	
							<div class="col-md-4 form-group">
								<div class="input-group">
									...
									<select class="form-control cltype" name="cltype" id="cltype">
										<option value="1" {{($return->cltype==1?'selected':'')}}>Parent</option>
										<option value="0" {{($return->cltype==0?'selected':'')}}>Child</option>
									</select>
								</div>
							</div>
						</div>	
							...
							<div class="col-md-4 form-group {{ $errors->has('location') ? ' has-error' : '' }}" id="location-group">
								<div class="input-group">
									...
									<select class="form-control location" name="location" id="location">
										...
										<option value="{{$loc->code}}" {{$loc->code==$return->location?'selected':''}} >{{$loc->description}}</option>
										@endforeach
									</select>
								</div>
							</div>	
								...
								<table class="ui-inv-details table-reponsive" style="width:100%">
									...
									<tbody class="inv-details">
										...
										<tr id="tr_{{$i}}">
											...
											<td><input type="radio" name="iradio[]" class="form-control-grid rct-details radioPick"  id="iradio_{{$i}}"   checked></td>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-12">
										<input type="text" name="crinvno" class="form-control col-md-3 pull-left" id="crinvno" value="{{$return->invno}}" readonly style="width:20%;display: noxne;">
							...
							<div class="col-md-12">
								<div class="form-group {{ $errors->has('remarks') ? ' has-error' : '' }}">
									<div class="input-group">
										...
										<textarea type="text" name="remarks"  id="remarks" class="form-control" style="resize: none">{{$return->remarks}}</textarea>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								...
								<table class="table-items" style="width:100%;" >
									...
									<tbody class="inv-items-body">
										<?php $i=1?>
										@foreach($return->return_details as $detail)
										<tr>
											<td><input type="checkbox" name="check_[]" class="form-control-grid rct-details checkSel"  id="check_{{$i}}" checked></td>
											<td style="width:15%"><input type="text" name="selcode[]" class="form-control-grid rct-details"  id="selcode_{{$i}}"  value="1" readonly style="display:none;"><input type="text" name="icode[]" class="form-control-grid rct-details"  id="icode_{{$i}}"  value="{{$detail->icode}}" readonly></td>
											<td style="width:35%"><input type="text" name="idesc[]" class="form-control-grid rct-details"  id="idesc_{{$i}}"  value="{{$detail->idesc}}" readonly></td>
											<td style="width:10%"><input type="text" name="punit[]" class="form-control rct-details text-right"  id="punit_{{$i}}"  value="{{$detail->uom}}" readonly></td>
											<td style="width:10%"><input type="text" name="rate[]" class="form-control rct-details text-right"  id="rate_{{$i}}"  value="{{$detail->rate}}" readonly></td>
											<td style="width:10%"><input type="text" name="qty[]" class="form-control rct-details text-right"  id="qty_{{$i}}"  value="{{$detail->qty}}"></td>
											<td style="width:10%"><input type="text" name="vat[]" class="form-control rct-details text-right ivat"  id="vat_{{$i}}"  value="{{$detail->vat}}"></td>
											<td style="width:15%"><input type="text" name="total[]" class="form-control rct-details text-right itotal"  id="total_{{$i}}"  value="{{$detail->total}}" readonly></td>
										</tr>
										<?php $i+=1;?>
										@endforeach
									...
									<div class="col-md-6">
										<div class="pull-right form-group {{ $errors->has('gvat') ? ' has-error' : '' }}">
											<div class="input-group">
												...
												<input type="text" name="gvat"  id="gvat" class="text-right form-control gvat" value="{{$return->vat}}" placeholder="" readonly>
											</div>
										</div>	
									</div>
									<div class="col-md-6">
										<div class="pull-right form-group {{ $errors->has('gtotal') ? ' has-error' : '' }}">
											<div class="input-group">
												...
												<input type="text" name="gtotal"  id="gtotal" class="text-right form-control gtotal" value="{{$return->amount}}" placeholder="" readonly>
											</div>
										</div>	
									</div>
								</div>					   						
			...
			$.ajax({
				...
				complete:function(res){
					...
					for (i in uts){
						...
						'<td style="width:10%"><input type="text" name="qty[]" class="form-control rct-details text-right"  id="qty_'+i+'"  value="'+uts[i].qty+'"></td>'+
						'<td style="width:10%"><input type="text" name="rate[]" class="form-control rct-details text-right"  id="rate_'+i+'"  value="'+uts[i].price+'" readonly></td>'+
						'<td style="width:10%"><input type="text" name="vat[]" class="form-control rct-details text-right ivat"  id="vat_'+i+'"  value="'+uts[i].vat+'" ></td>'+
