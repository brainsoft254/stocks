...
<body>
    ...
    <div class="invoice-box">
        ...
        <table cellpadding="0" cellspacing="0" style="width:100%">
                    ...
                    <table style="width:100%;border-bottom: solid 1px #272822;">
                        <tr>
                            ...
                            <td class="inv-details">
                                ...
                                <strong>DOC-TYPE: {{$issue->trantype>0?'TRANSFER':'ISSUE'}}</strong><br>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="itemx">
                <td class="text-left">{{$det->code}}</td>
                ...
                <td class="text-left">{{$det->bprice}}</td>
                        ...
                        <tr>
                            <td>
                             <ul style="list-style: none;">
                                @switch($issue->status)
                                    @case(1) 
                                        <li><span class="alert alert-success"><i>{{$issue->trantype>0?'Transfered':'Issued'}} </i></li>
                                        @break
                                    @case(0) <li class="alert alert-danger"><i>..Waiting to be processed</i></li>
                                        @break
                                @endSwitch
