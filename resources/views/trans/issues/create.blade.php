	...
	<div class="col-md-10">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="text-default"><i class="fa fa-magic "></i> <strong> New Issue/Transfer </strong></h3>
			</div>
			<div class="panel-body">
				<form class="form-order" action="{{route('issues.store')}}" method="POST">
					@csrf
					<div class="row">
						<div class="col-md-3">
							<div class="form-group {{ $errors->has('refno') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<input type="text" name="refno" class="form-control" value=""  placeholder="SYSGEN" readonly>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group {{ $errors->has('trandate') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<input type="text" name="trandate" class="form-control trandate" id="trandate" placeholder="Trandate"  value="{{$today}}" readonly="">
								</div>
							</div>
						</div>
						<div class="col-md-5">
							<div class="form-group {{ $errors->has('trantype') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<select class="form-control trantype" name="trantype" id="trantype">
										<option value="-1" selected="selected">--Select Trantype--</option>
							...
							<div class="form-group {{ $errors->has('client') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<select class="form-control requestno" name="requestno" id="requestno">
										<option value="-1" selected="selected">--Select RequestNo--</option>
										@foreach($requisitions as $reqs)
										<option value="{{$reqs->refno}}">{{$reqs->refno}}</option>
										@endforeach
									</select>
								</div>
							</div>	
						...
						<div class="col-md-7">
							<div class="form-group {{ $errors->has('remarks') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<textarea class="form-control" name="remarks" id="remarks" rows=2 style="resize: none;"></textarea>
								</div>
							</div>
						</div>
						<div class="col-md-5">
