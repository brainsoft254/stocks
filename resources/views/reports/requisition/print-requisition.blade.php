                    ...
                    <table style="width:100%;border-bottom: solid 1px #272822;">
                        <tr>
                            ...
                            <td class="inv-details">
                                <strong>RefNo: #{{$requisition->refno}}</strong><br>
                                <strong>Date: {{$requisition->trandate}}</strong><br>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="9">
                    <table>
                        <tr>
                            <td>
                                <strong>From:</strong>
                                <strong>{{$requisition->locfrom}}</strong><br>
                                <strong>({{Stockspro::getLocationName($requisition->locfrom)}})</strong><br>
                            </td>
                            <td>
                                <strong>To:</strong>
                                <strong>{{$requisition->locto}}</strong><br>
                                <strong>({{Stockspro::getLocationName($requisition->locto)}})</strong><br>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <td class="bill-totals" colspan="4" style="width:100%!important;">
                <table >
                    <tr class="figures">
                        ...
                        <td class="text-right">{{number_format($requisition->total,0)}}</td>
                    </tr>
                    <tr class="figures">
...
<script type="text/javascript">
 $(function(){
    $(document).on('click','#btnPrintPdf',function(e){
        e.preventDefault();
        var datastr='&refno={!!$requisition->refno!!}';
