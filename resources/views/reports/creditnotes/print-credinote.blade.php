...
<head>
    ...
    /*.invoice-box table tr.total td:nth-child(8),tr.total td:nth-child(9) {
        ...
        .dotted {
          bcreditnote:none;
          bcreditnote-top:1px dotted #000;
          color:#000;
    ...
    <div class="invoice-box">
        ...
        <table cellpadding="0" cellspacing="0" style="width:100%">
                    ...
                    <table style="width:100%;bcreditnote-bottom: solid 1px #272822;">
                        <tr>
                            ...
                            <td class="inv-details">
                                <strong>RefNo: #{{$creditnote->refno}}</strong><br>
            ...
            <tr class="heading">
                ...
                <td class="text-right" style="text-align: right!important;">Invadte</td>
                <td class="text-right" style="text-align: right!important;">Credit Amnt</td>
            </tr>
            @foreach ($details as $det)
            <tr class="itemx">
                <td class="text-left">{{$det->invno}}</td>
                <td class="text-left" style="text-align: left!important; width:100%" >{{$det->rmks}}</td>
                <td class="text-left">{{$det->invdate}}</td>
