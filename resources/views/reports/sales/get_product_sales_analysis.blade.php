	...
	<div class ="col-md-6">
		<div class="box box-danger">
			<div class="box-header">
				<h3 class="text-danger text-center"><span class="fa fa-pie-chart"> </span><strong> Print Sales Analysis-{BY PRODUCT}</strong></h3>
				<span class="ui-alert col-md-12">  </span>
			</div>
			<div class="box-body">
				<form class="form-print-stat" action ="{{url('print-product-sales-analysis')}}" method ="GET">
					@csrf
					<div class="row">
...
<script type="text/javascript">
	$(function(){
			    ...
			    $('#product').select2();
			    $('#product,#location,#clcode').select2({theme:'bootstrap',dropdownAutoWidth : true,width:'100%',dropdownParent: $('.box-body')});
