...
<head>
    <meta charset="utf-8">
    <title>Client Sales Analysis Report [{{$client}}]</title>
        ...
        <div class="main-header">
            <td class="coy-info">
                ...
                <div>
                    ...
                    @if($client!='-1')
                    <span><strong>{{Stockspro::getClientName($client)}} ( {{ $client }} )</strong></span>
                    @else
                        ...
                        @foreach ($sales as $sale)
                            <tr class="itemx">
                                <td class="text-left" style="text-align: center!important; width:10%">
                                    {{ $i }}</td>
                                <td class="text-left"
                                    style="text-align: left!important; width:25%;padding-left: 4px">
                                    {{$sale->code }}
                                </td>
                                <td class="text-left"
                                    style="text-align: left!important; width:100%;padding-left: 4px">
                                    {{ Str::title(Stockspro::getClientName($sale->code)) }}
                                </td>
