...
<div class="invoice-box" >
    <table cellpadding="0" cellspacing="0"  style=" border-collapse: collapse; width:100%;">
      <tr class="information" >
        ...
        <td class="inv-detailsx">
            ...
            <table style="text-align: right;border-collapse: collapse; width: 100%!important;">
    ...
    <tr><td colspan=2 style="border-bottom: solid 1px #000;"><br/></td></tr>
    <tr>
        <td class="customer-details">
            <table style="border-collapse: collapse; width: 100%!important;">
                ...
                <tr><td>Texl:{{$clContacts->tel}}</td></tr>
...
<table style="border-collapse: collapse; width: 100%!important;">
    ...
    <tr class="itemx">
        ...
        <td class="text-left" style="font-size:12px;padding-left:2px; text-align: left !important; width:70%">{{$det->idesc}}</td>
