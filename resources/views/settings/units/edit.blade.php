	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-unit" action="{{route('units.update',$unit->id)}}" method="POST">
					@csrf @method('PUT')
					<div class="row">
						<div class="col-md-5">
						...
						<div class="col-md-3">
							<div class="form-group {{ $errors->has('factor') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<input type="text" name="factor" class="form-control" value="1" value="{{$unit->factor}}" >
								</div>
							</div>
						</div>
						<div class="col-md-4">
