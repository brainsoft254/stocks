	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="text-default"><i class="fa fa-magic"></i> <strong> New Packing Unit</strong></h3>
			</div>
			<div class="panel-body">
				<form class="form-unit" action="{{route('units.store')}}" method="POST">
					@csrf
					<div class="row">
						<div class="col-md-5">
						...
						<div class="col-md-3">
							<div class="form-group {{ $errors->has('factor') ? ' has-error' : '' }}">
								<div class="input-group">
									<span class="input-group-addon primary">Factor</span>
									<input type="text" name="factor" class="form-control" value="1" placeholder="1" >
								</div>
							</div>
						</div>
						<div class="col-md-4">
...
<script type="text/javascript">
	$(function(){
		...
		$('form.form-unit').on('submit', function(submission) {
			
			submission.preventDefault();

			swal("Save Location Details?", {
				buttons: {
					cancel: "Run away!",
					catch: {
						text: "Proceed!",
