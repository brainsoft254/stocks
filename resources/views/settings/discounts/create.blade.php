	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="text-default"><i class="glyphicon glyphicon-tower"></i> <strong> New Sales Discount</strong></h3>
			</div>
			<div class="panel-body">
				<form class="form-category" action="{{route('discounts.store')}}" method="POST">
					@csrf
					<div class="row">
						<div class="col-md-6">
							<div class="form-group {{ $errors->has('code') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<input type="text" name="code" class="form-control" placeholder="Enter account code" >
								</div>
							</div>
						</div>
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="form-group {{ $errors->has('rate') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<input type="text" name="rate" class="form-control" placeholder="Enter Discount Rate"  value="0">
								</div>
							</div>
						</div>
					</div>
