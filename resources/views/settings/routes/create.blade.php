	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="text-default"><i class="glyphicon glyphicon-tower"></i> <strong> New Route</strong></h3>
			</div>
			<div class="panel-body">
				<form class="form-route" action="{{route('routesman.store')}}" method="POST">
					@csrf
					<div class="row">
						<div class="col-md-6">
							<div class="form-group {{ $errors->has('code') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<input type="text" name="code" class="form-control" placeholder="Enter Route Code" >
								</div>
							</div>
						</div>
						<div class="col-md-6">
						...
						<div class="col-md-12">
							<div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<input type="text" name="description" class="form-control" placeholder="Enter Route description" >
								</div>
							</div>
						</div>
					</div>
							...
							<div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
								<div class="input-group">
									...
									<select class="form-control" name="rep" id="rep">
										<option value="-1" selected="selected">Select Rep--</option>
...
<script type="text/javascript">
	$(function(){
		...
		$('form.form-route').on('submit', function(submission) {
			
			submission.preventDefault();

			swal("Save Route Details?", {
				buttons: {
					cancel: "Run away!",
					catch: {
						text: "Proceed!",
