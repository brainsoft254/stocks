        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="title">Edit Client Profile </h3>
                </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="tab-info" style="padding-top:10px;">
                        <form class="form-client" id="form-client" action="{{route('clients.update',$client->id)}}" method="POST" novalidate="" >
                            @csrf @method('PUT')
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('code') ? ' has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <input id="code" type="text" class="form-control" name="code" value="{{$client->code}}" required readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 btn_toggle">
                                    <input type="checkbox" class="form-control" name="hasvat" id="hasvat" {{$client->hasvat==1?'checked':''}} data-toggle="toggle" data-on="<i class='fa fa-check-square-o'></i>HasVat"  data-off="<i class='fa fa-times'></i>NoVat" data-onstyle="success" data-offstyle="danger" >
                                </div>                            
                                ...
                                <div class="col-md-3 btn_toggle">
                                    <input type="checkbox" class="form-control" name="vatexc" id="vatexc" {{$client->vatexc==1?'checked':''}} data-toggle="toggle" data-on="<i class='fa fa-check-square-o'></i>Vatable"  data-off="<i class='fa fa-times'></i>VAT Exc" data-onstyle="success" data-offstyle="danger" >
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 btn_toggle">
                                    <input type="checkbox" class="form-control" name="factax" id="factax" {{$client->factax==1?'checked':''}} data-toggle="toggle" data-on="<i class='fa fa-check-square-o'></i> Has Fac.Charge"  data-off="<i class='fa fa-window-close'></i> No Fac.Charge" data-onstyle="danger" data-offstyle="success" >
                                </div>                            
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('pobox') ? ' has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <input id="pobox" type="text" class="form-control" name="pobox" value="{{$client->pobox }}" required autofocus >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <input id="email" id="email" type="email" class="form-control" name="email" value="{{$client->email}}" required autofocus placeholder="Enter Email">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('tel') ? ' has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <input id="tel" type="text" class="form-control" name="tel" value="{{ $client->tel }}" required autofocus placeholder="Enter Cellphone">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2 btn_toggle">
                                    <input type="checkbox" class="form-control" name="parent" id="parentcl" {{$client->parent==1?'checked':''}} data-toggle="toggle" data-on="<i class='fa fa-check-square-o'></i>Parent Client"  data-off="<i class='fa fa-check-square-o'></i>Child Client" data-onstyle="success" data-offstyle="danger" >
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('attachedto') ? ' has-error' : '' }}" id="attach-group">
                                        <div class="input-group" >
                                            ...
                                            <select class="form-control" name="attachedto" id="attachedto">
                                                ...
                                                <option value="{{$parent->code}}" {{$client->attachedto==$parent->code? 'selected':''}}>{{$parent->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('pinno') ? ' has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <input id="pinno" type="text" class="form-control" name="pinno" value="{{$client->pinno}}" required autofocus placeholder="Enter Pin No">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('paymode') ? ' has-error' : '' }}" id="status-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="paymode" id="paymode">
                                                <option value="1" {{$client->paymode==1?'selected':''}}>Cash</option>
                                                <option value="0" {{$client->paymode==0?'selected':''}}>Account</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('physicaladd') ? ' has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <textarea style="resize: none" id="physicaladd" id="physicaladd" type="text" class="form-control" name="physicaladd"  required autofocus placeholder="Enter Physical Address">{{ $client->padd }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('remarks') ? ' has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <textarea style="resize: none" id="remarks" id="remarks" type="text" class="form-control" name="remarks"  required autofocus placeholder="Enter Remarks">{{$client->remarks}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('contact_person') ? ' has-error' : '' }}">
                                            <div class="input-group">
                                                ...
                                                <input  id="contact_person" type="text" class="form-control" name="contact_person" value="{{ $client->contact_person}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('concell') ? ' has-error' : '' }}">
                                            <div class="input-group">
                                                ...
                                                <input  id="concell" type="text" class="form-control" name="concell" value="{{ $client->concell }}" required autofocus placeholder="Enter Contact Person CellPhone">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('conemail') ? ' has-error' : '' }}">
                                            <div class="input-group">
                                                <span class="input-group-addon warning"><i class="fa fa-envelope fa-fw"></i> Conatct Email</span>
                                                <input id="conemail" id="conemail" type="email" class="form-control" name="conemail" value="{{$client->conemail}}" required autofocus placeholder="Enter Contact Person Email">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('route') ? ' has-error' : '' }}" id="route-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="route" id="route">
                                                ...
                                                <option value="{{$route->code}}" {{($route->code==$client->route?'selected':'')}}>{{$route->code}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group {{ $errors->has('rep') ? ' has-error' : '' }}" id="route-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="rep" id="rep">
                                                ...
                                                <option value="{{$staff->name}}" {{($staff->name==$client->rep?'selected':'')}}>{{$staff->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="tab-items" style="padding-top: 10px;">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{route('clitems.create')}}" class="btn btn-warning pull-left" id="btnNewItem"><i class="fa fa-cart-plus"></i> Add Client Items</a>
                            </div>
                        </div>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a id="edit_Link" class="dropdown-item text-default" href="{{route('clitems.edit',$item->id)}}"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a></li>
                                            <li role="separator" class="divider"></li>
                                            <li ><input type="hidden" value="<?php echo csrf_token(); ?>" name="_token"><a class="text-primary" id="delete_Link" href="{{route('clitems.destroy',$item->id)}}" idd="{{$item->id}}" class="text-primary"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
...
<script type="text/javascript">
    $(function(){
        ...
        var v_parent={!!$isParent!!};

        $('#tbl-clients-items').DataTable();
        $('#status,#attachedto,#route,#rep').select2({theme:'bootstrap',width:'100%',dropdownParent: $('.modal')});
        $('.toggle').css('width','100px');
        $('#parentcl,#vatexc,#hasvat,#factax').bootstrapToggle();
        $('#attach-group').hide();

        if(v_parent==0){$('#attach-group').show();}
        ...
        $(document).on('click','a#delete_Link',function(e){
            ...
            swal("Delete Selected Item {"+v_id+"} ?", {
                buttons: {
                    cancel1: {
                        text:"Close",
                        value: "close",
                ...
                switch (value) {
                    ...
                    $.ajax({
                        ...
                        complete:function(xhr){
                                ...
                                swal("Deleted",xhr.responseText,"success");
                                //location.reload();
                            }
                        });
