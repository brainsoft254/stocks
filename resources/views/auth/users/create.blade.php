        ...
        <div class ="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <i class="glyphicon glyphicon-user"></i><strong> Register New User</strong>
                </div>
                <div class="panel-body">
                    <form class="signup-form" id="signup-form" action="{{ route('users.store') }}" method="POST" novalidate="">
                        @csrf
                        <div class="row">
                            <div class ="col-md-12">
                            ...
                            `            <span class="input-group-addon primary"><i class="fa fa-book fa-fw"></i> Name</span>
                                        <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }} underlined" name="name" value="{{ old('name') }}" required autofocus placeholder="Enter Fullnames">
                            ...
                            <div class ="col-md-12">
                                <div class="form-group" id="email-group">
                                    <div class="input-group">
                                        ...
                                        <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} underlined " name="email" value="{{ old('email') }}" placeholder="Email Address" required>
                                        @if ($errors->has('email'))
                                        <span class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class ="col-md-6">
                                <div class="form-group" id="password-group">
                                    <div class="input-group">
                                        <span class="input-group-addon warning"><i class="fa fa-shield fa-fw"></i> Password</span>
                                        <input id="password" type="password" class="underlined form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required placeholder="Password">
                            ...
                            <div class ="col-md-6">
                                <div class="form-group" id="confirm-group">
                                    <div class="input-group">
                                        <span class="input-group-addon warning"><i class="fa fa-shield fa-fw"></i> Confirm</span>
                                        <input id="password-confirm" type="password" class="underlined form-control" name="password_confirmation" required placeholder="Confirm Password">
                                    </div>
                                </div>
                            </div>
                        </div>
