...
Create DEFINER=`semaphon`@`localhost` procedure  do_audit_trail(v_staff varchar(30),v_operation text)
begin
insert into audit_trail(atdate,attime,staff,operation)
  ...
  CREATE DEFINER=`semaphon`@`localhost` FUNCTION `get_next_number`(
   `v_ntype` varchar(20),
   `ttype` boolean
   )
  ...
  Create DEFINER=`semaphon`@`localhost` procedure do_post_grn(v_refno varchar(25),v_staff varchar(250),v_reverse boolean)
  Begin
  ...
  update grn set status=1 where refno=v_refno;
    ...
    update grn set status=1 where refno=v_refno;
      END CASE;
        ...
        call do_post_grn_details(v_refno,v_staff);iyadh
(GMT+03:30) Tiyadh
(GMT+03:30) T
        update grn set status=1 where refno=v_refno;
          END IF;
      ...
      update grn set status=0 where refno=v_refno;
        ...
        Create DEFINER=`semaphon`@`localhost` procedure do_post_grn_details(v_grn varchar(25),v_staff varchar(255))
        Begin
...
Create DEFINER=`semaphon`@`localhost` PROCEDURE  do_reverser_grn(v_refno)
Begin
...
CREATE DEFINER=`semaphon`@`localhost` PROCEDURE `do_gl`(IN `v_code` varchar(30),IN `v_remarks` varchar(50),IN `v_amt` decimal(20,2),
  IN `v_date` date,IN `v_trancode` varchar(30),IN `v_trantype` varchar(30),IN `v_sign` char(1),IN `v_source` varchar(30),
  IN `v_staff` varchar(30),IN v_location varchar(150))
BEGIN
IF v_amt >0 THEN
...
CREATE DEFINER=`semaphon`@`localhost` PROCEDURE `do_itran`(IN `v_icode` varchar(100), IN `v_trancode` varchar(30), IN `v_date` date, IN `v_sign` char(1), IN `v_qty` decimal(20,2),
  IN `v_cost` decimal(20,2), IN `v_loc` varchar(30), IN `v_staff` varchar(30), IN `v_source` varchar(20),v_punit varchar(25),v_factor integer)
BEGIN
...
CREATE DEFINER=`semaphon`@`localhost`  FUNCTION `get_pu_factor`(`v_pu` varchar(30)) RETURNS decimal(20,2)
BEGIN
...
CREATE DEFINER=`semaphon`@`localhost` FUNCTION get_desc_special(v_item varchar(50), v_client varchar(50))RETURNS varchar(255) 
BEGIN
...
CREATE DEFINER=`semaphon`@`localhost` FUNCTION if_special_treat(v_icode varchar(50),v_ccode varchar(50)) RETURNS decimal(20,2)
BEGIN
...
CREATE DEFINER=`semaphon`@`localhost` FUNCTION is_child(v_child varchar(30)) RETURNS int(11)
Begin
...
CREATE DEFINER=`semaphon`@`localhost` FUNCTION get_sprice(v_item varchar(50),v_client varchar(50)) RETURNS decimal(20,2)
BEGIN
...
CREATE DEFINER=`semaphon`@`localhost` FUNCTION get_parent(v_child varchar(30)) RETURNS varchar(30) CHARSET latin1
Begin
...
CREATE DEFINER=`semaphon`@`localhost` FUNCTION `get_client_code`(v_name varchar(150)) RETURNS varchar(50) 
BEGIN
...
CREATE DEFINER=`semaphon`@`localhost` FUNCTION `get_invoice_clcode`(v_invno varchar(50)) RETURNS varchar(50) 
BEGIN
...
CREATE DEFINER=`semaphon`@`localhost` FUNCTION `get_client_name`(v_code varchar(30)) RETURNS varchar(50) 
BEGIN
...
CREATE DEFINER=`semaphon`@`localhost` FUNCTION get_item_qty(v_code varchar(100),v_loc varchar(150)) RETURNS integer
BEGIN
declare v_qty integer  default 0;
...
CREATE DEFINER=`semaphon`@`localhost` PROCEDURE do_post_order(v_refno varchar(25),v_staff varchar(200),v_reverse int)
BEGIN
IF NOT v_reverse THEN 
...
CREATE DEFINER=`semaphon`@`localhost` PROCEDURE `do_order_details_posting`(v_refno varchar(30),v_staff varchar(30))
begin
...
IF NOT done THEN
       ...
       CREATE DEFINER=`semaphon`@`localhost` PROCEDURE `do_reverse_order_posting`(v_refno varchar(30),v_staff varchar(30))
       begin
       declare v_icode varchar(30);
       declare v_bprice decimal(20,2) default 0;
       declare v_sprice decimal(20,2) default 0;
       ...
       CREATE DEFINER=`semaphon`@`localhost` FUNCTION `get_stock_act`(v_code varchar(30)) RETURNS varchar(30)
       BEGIN
       ...
       CREATE DEFINER=`semaphon`@`localhost` FUNCTION `get_cog_act`(v_code varchar(30)) RETURNS varchar(30) 
       BEGIN
       declare v_act varchar(30);
       ...
       CREATE DEFINER=`semaphon`@`localhost` FUNCTION `get_revenue_act`(v_code varchar(30)) RETURNS varchar(30) 
       BEGIN
       declare v_act varchar(30);
       ...
       CREATE DEFINER=`semaphon`@`localhost` FUNCTION `get_vat_act`() RETURNS varchar(150) 
       BEGIN
       ...
       CREATE DEFINER=`semaphon`@`localhost` PROCEDURE do_order_invoice_d(v_refno varchar(50),v_invno varchar(50))
       BEGIN
       ...
       CREATE DEFINER=`semaphon`@`localhost` PROCEDURE `do_post_invoice`(v_invno varchar(25),v_staff varchar(150))
       BEGIN
      ...
      ELSE
       ...
       CREATE DEFINER=`semaphon`@`localhost` PROCEDURE `do_reverse_invoice`(v_refno varchar(25),v_staff varchar(150))
       BEGIN
       declare v_account varchar(30);
       declare v_desc varchar(50);
       declare v_loc varchar(30);
       ...
       CREATE DEFINER=`semaphon`@`localhost` PROCEDURE `do_receivables`(IN v_account varchar(30), IN v_desc varchar(30), IN v_ref varchar(30), IN v_trantype varchar(100), IN v_date date, IN v_staff varchar(30), IN v_total decimal(20,2), IN v_transign char(1), IN v_vat decimal(20,2), IN v_loc varchar(30))
       BEGIN
       insert into receivables_transactions(code,remarks,amount,jtdate,trancode,trantype,transign,source,staff,vat,loc,created_at,updated_at)
        ...
        CREATE DEFINER=`semaphon`@`localhost`  FUNCTION isChild(v_client varchar(25)) RETURNS int(1)
        BEGIN
        ...
        CREATE DEFINER=`semaphon`@`localhost` FUNCTION getParent(v_child_client varchar(25)) RETURNS varchar(25)
        BEGIN
        ...
        CREATE DEFINER=`semaphon`@`localhost` FUNCTION isClientItem(v_client varchar(25),v_item varchar(200))RETURNS int
        BEGIN
        declare v_parent varchar(25);
        ...
        CREATE DEFINER=`semaphon`@`localhost` FUNCTION getItemDecrClient(v_item varchar(150),v_client varchar(25)) RETURNS varchar(255)
        BEGIN
        ...
        CREATE DEFINER=`semaphon`@`localhost` FUNCTION getClientPrice(v_item varchar(150),v_client varchar(25)) RETURNS decimal(10,2)
        BEGIN
        ...
        CREATE DEFINER=`semaphon`@`localhost` FUNCTION getItemQty(v_item varchar(150),v_location varchar(150)) RETURNS BIGINT
        BEGIN
        ...
        CREATE DEFINER=`semaphon`@`localhost` FUNCTION getStockValue(v_loc varchar(200))returns Decimal(20,2)
        BEGIN
        ...
        CREATE DEFINER=`semaphon`@`localhost` FUNCTION get_item_categ(v_icode varchar(100))RETURNS varchar(250) 
        BEGIN
        ...
        delimiter $$
        Create definer='semaphon'@'localhost' procedure  do_allocations (v_rno varchar(25),v_staff varchar(230))
        begin
        ...
        delimiter $$
        Create definer='semaphon'@'localhost' procedure  set_allocations(v_rno varchar(30),v_date date,v_amount decimal(20,2),v_unallocated decimal(20,2),v_staff varchar(30))
        begin
          ...
          update receipt_details set allocated = allocated + v_allocate where rno = v_rno and invno=v_invno and id = v_id ;
            ...
            update invoices set amount_paid = amount  where clcode =v_clcode and invno = v_invno;
              update receipt_details set allocated = allocated + v_due where rno = v_rno and invno=v_invno and id = v_id ;  
                ...
                Create definer='semaphon'@'localhost' procedure  do_unallocated(v_ref varchar(30),v_clcode varchar(20),v_rdate date,v_type varchar(20),v_trancode varchar(30),v_source varchar(30),v_id integer,v_balance decimal(20,2),v_amt decimal(20,2),v_sign char(1),v_posted smallint(1),v_staff varchar(20))
                begin
                if v_amt >0 then
                insert into allocations (refno,clcode,trandate,trantype,trancode,source,rdid,balance,amount,sign,staff,posted,created_at,updated_at)
                  ...
                  Create definer='semaphon'@'localhost' procedure  do_post_receipt(v_rno varchar(30),v_staff varchar(20),v_reverse int )
                  begin
               ...
               # DECLARE EXIT HANDLER FOR SQLEXCEPTION SET _rollback = 1;
                ...
                select 
                trandate,bankdate,clcode,account,amount,wtax,chequeno,remarks,location,rno,count(rno) as cnt
                into
                v_rdate,v_bankdate,v_clcode,v_account,v_amount,v_wtax,v_cheque,v_remarks,v_location,v_refno,v_cnt
                from receipts  where rno = v_rno and if(v_reverse=1,status =1,status=0) group by rno;

                if v_cnt >0 then
                call do_post_receipt_master(v_clcode,v_account,v_cheque,v_amount,v_rno ,v_clcode,v_bankdate,v_staff ,v_wtax,v_reverse,v_location);
                end if;
              ...
              CREATE definer='semaphon'@'localhost' PROCEDURE do_post_receipt_details(v_code varchar(30),v_account varchar(30),v_cheque varchar(30),v_amt decimal(20,2),v_ref varchar(30),v_source varchar(30),v_date date,v_staff varchar(30),_reverse int,v_location varchar(150))
              BEGIN
              declare v_receivables_control varchar(130);
              ...
              END; $$
                    ...
                    create definer='semaphon'@'localhost' procedure do_post_receipt_master(v_code varchar(30),v_account varchar(30),v_cheque varchar(30),v_amt decimal(20,2),v_ref varchar(30),v_source varchar(30),v_date date,v_staff varchar(30),v_wtax decimal(20,2),_reverse int,v_loc varchar(150))
                      begin
                      declare v_vat_control varchar(130);
                      ...
                      create  DEFINER='semaphon'@'localhost' procedure do_post_ap_invoice(v_invno varchar(30),v_staff varchar(30),v_reverse boolean,v_location varchar(150))
                        begin
                        DECLARE _rollback BOOL DEFAULT 0;
...
#DECLARE CONTINUE HANDLER FOR SQLEXCEPTION SET _rollback = 1;
  ...
  CREATE  DEFINER='semaphon'@'localhost' PROCEDURE do_payable_trans(IN v_scode varchar(30), IN v_remarks varchar(50), IN v_amt decimal(20,2), IN v_date date, IN v_trancode varchar(30), IN v_trantype varchar(30), IN v_sign char(1), IN v_source varchar(30), IN v_staff varchar(30))
  begin
  if v_amt >0 then
  insert into payable_trans(code,remarks,amount,jtdate,trancode,trantype,transign,source,staff,staffdate)
    ...
    create  DEFINER='semaphon'@'localhost' procedure do_post_ap_invoice_details(v_invno varchar(30),v_staff varchar(30),v_scode VARCHAR(30),v_date date,v_location varchar(100))
      begin
      declare done int default 0;
      declare v_code varchar(25);
      ...
      create  DEFINER='semaphon'@'localhost' procedure do_post_ap_receipt(v_date date,v_rno varchar(30),v_scode VARCHAR(30),v_amount decimal(20,2),v_account varchar(30),v_cheque varchar(30),v_staff varchar(30))
        begin
        declare done int default 0;
        declare v_invno varchar(25);
            ...
            insert into apreceipt_details (rno,invno,due,paid)
              ...
              update apinvoices set amountpaid = amount  where scode =v_scode and invno = v_invno;
                ...
                update apreceipts set status =1 where rno = v_rno and status =0; 
                  ...
                  CREATE DEFINER='semaphon'@'localhost' PROCEDURE do_logqty(v_itemcode varchar(100),v_storeqty int, v_orderqty int ,v_store varchar(100),v_refno varchar(100))
                  BEGIN
                  ...
                  CREATE DEFINER='semaphon'@'localhost' FUNCTION isVatExc(v_client varchar(25))RETURNS integer
                  BEGIN
                  ...
                  CREATE DEFINER='semaphon'@'localhost' PROCEDURE do_post_payment(v_refno varchar(35),v_staff varchar(250),v_location varchar(150))
                  BEGIN
                  declare v_total decimal(20,2);
                  ...
                  CREATE DEFINER='semaphon'@'localhost' PROCEDURE do_post_payment_d(v_refno varchar(35),v_staff varchar(200),v_location varchar(150))
                  BEGIN
                  declare done int default 0;
                  ...
                  CREATE DEFINER='semaphon'@'localhost' PROCEDURE do_reverse_payment(v_refno varchar(35),v_staff varchar(250))
                  BEGIN
                  declare v_total decimal(20,2);
                  declare v_account varchar(150);
                  declare v_trandate date;
                  ...
                  Create DEFINER='semaphon'@'localhost' procedure do_post_creditnote(v_refno varchar(25),v_staff varchar(150), v_post int)
                  Begin 
                  ...
                  /*Post Creditnote*/
                    ...
                    update invoices set amount_paid=amount_paid-v_cr_amnt where invno=v_invno and clcode=v_clcode_;
                     ...
                     CREATE DEFINER='semaphon'@'localhost' procedure do_client_statement(v_code varchar(30),v_defrom date,v_deto date)
                     begin
...
CREATE DEFINER='semaphon'@'localhost' procedure do_client_statement_parent(v_code varchar(30),v_defrom date,v_deto date,v_with_self integer)
begin
...
insert into clstat(code,jtdate,jdate,trancode,tranref,trandesc,debit,credit)
 ...
 and jtdate  < v_defrom;
  ...
  CREATE DEFINER='semaphon'@'localhost' PROCEDURE do_client_sales_analysis(v_dfrom date , v_dto date, v_clcode varchar(25),v_parent boolean)
  BEGIN
  ...
  CREATE DEFINER='semaphon'@'localhost' PROCEDURE do_post_returns(v_refno varchar(100),v_staff varchar(200),v_post boolean)
  BEGIN
  declare v_amount decimal(20,2);
  declare v_invno varchar(50);
  ...
  CREATE DEFINER='semaphon'@'localhost' PROCEDURE do_create_return_creditnote(v_refno varchar(50),v_staff varchar(200))
  BEGIN
  ...
  CREATE DEFINER='semaphon'@'localhost' PROCEDURE do_post_return_details(v_refno varchar(50),v_staff varchar(100))
  BEGIN
        declare done integer default 0;
  ...
  CREATE DEFINER='semaphon'@'localhost' PROCEDURE do_sales_by_product(v_icode varchar(150),v_dfrom date,v_dto date, v_location varchar(25),v_clcode varchar(25))
  BEGIN
...
CREATE  DEFINER='semaphon'@'localhost' PROCEDURE do_client_aging(v_client varchar(25),v_rd integer,v_bal decimal(20,2),v_status integer,v_parent integer )
BEGIN
  ...
  CREATE  DEFINER='semaphon'@'localhost' PROCEDURE do_age_client(v_clcode varchar(30),v_rd integer,v_bal decimal(20,2),v_parent integer)
  BEGIN
