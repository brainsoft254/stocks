...
Route::group(['middleware' => ['web','auth']], function() {
	...
	Route::get('get-client-fly','clientsController@createclient_fly');
	...
	Route::get('get-pos-receipt', 'receiptsController@get_pos_receipt');
	Route::post('save-pos-receipt', 'receiptsController@save_pos_receipt');
	Route::get('get-pos-analysis', 'receiptsController@get_pos_analysis');
	Route::get("print-pos-analysis","receiptsController@print_pos_analysis");
