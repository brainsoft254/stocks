...
class DashboardController extends Controller
{
    ...
    public function index()
    {
       ...
       ->get();
        ...
        //dd($inventValue);
        return view('dashboard')->with(['orders'=>$orders,'orderlist'=>$orderlist,'inventvalue'=>$inventValue,'balances'=>$balances,'receipts'=>$receipts,'currentdate'=>$start,'DSSales'=>$DSSales,'creditnotes'=>$creditnotes,'routesales'=>$routesales]);
    }
